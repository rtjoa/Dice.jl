...
bdd = compile(code)
@assert infer(bdd.bit & !bdd.error) ≈ 0.0625

code = code_arith(+, 2, 3, 0)
bdd = compile(code)
@assert infer(bdd.bit & !bdd.error) ≈ 0.03125
...
code = code_arith(-, 2, 2, 0)
bdd = compile(code)
@assert infer(bdd.bit & !bdd.error) ≈ 0.25
...
code = code_arith(-, 3, 2, 0)
bdd = compile(code)
@assert infer(bdd.bit & !bdd.error) ≈ 0.125

code = code_arith(*, 2, 2, 0)
bdd = compile(code)
@assert infer(bdd.bit & !bdd.error) ≈ 0.4375

code = code_arith(*, 1, 2, 0)
bdd = compile(code)
@assert infer(bdd.bit & !bdd.error) ≈ 0.625

code = code_arith(*, 3, 2, 0)
bdd = compile(code)
@assert infer(bdd.bit & !bdd.error) ≈ 0.34375
